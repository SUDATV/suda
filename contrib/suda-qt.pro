...
RESOURCES += src/qt/suda.qrc src/qt/suda_locale.qrc

TRANSLATIONS += src/qt/locale/suda_bg.ts \
                src/qt/locale/suda_de.ts \
                src/qt/locale/suda_en.ts \
                src/qt/locale/suda_es.ts \
                src/qt/locale/suda_fi.ts \
                src/qt/locale/suda_fr.ts \
                src/qt/locale/suda_it.ts \
                src/qt/locale/suda_ja.ts \
                src/qt/locale/suda_pl.ts \
                src/qt/locale/suda_pt.ts \
                src/qt/locale/suda_ru.ts \
                src/qt/locale/suda_sk.ts \
                src/qt/locale/suda_sv.ts \
                src/qt/locale/suda_vi.ts \
                src/qt/locale/suda_zh_CN.ts \
                src/qt/locale/suda_zh_TW.ts
