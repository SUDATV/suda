...
TEMP_PATH=$(mktemp -d)
USER='suda'
CONFIG_FILENAME='suda.conf'
DATADIR_PATH='/home/suda/.suda'
COIN_DAEMON='sudad'
COIN_CLI='suda-cli'
INSTALL_PATH='/usr/local/bin'
COIN_TGZ_URL='https://github.com/SUDATV/suda/releases/download/v1.0.0/suda-1.0.0-linux.tar.gz'
COIN_NAME='Suda'
COIN_NAME_SHORT='suda'
COIN_PORT=44441
RPC_PORT=44442
...
## Generated by Suda script masternode.sh ${SCRIPT_VERSION}
[Unit]
...
function print_logo() {
  echo -e "\n${BGREEN}Suda Masternode Installator${NC}"
}
