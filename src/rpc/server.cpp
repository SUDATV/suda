...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop Suda Coin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "Suda Coin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* suda features */
        {"suda", "listmasternodes", &listmasternodes, true, true, false},
        {"suda", "getmasternodecount", &getmasternodecount, true, true, false},
        {"suda", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"suda", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"suda", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"suda", "masternodecurrent", &masternodecurrent, true, true, false},
        {"suda", "masternodedebug", &masternodedebug, true, true, false},
        {"suda", "startmasternode", &startmasternode, true, true, false},
        {"suda", "createmasternodekey", &createmasternodekey, true, true, false},
        {"suda", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"suda", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"suda", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"suda", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"suda", "getmasternodescores", &getmasternodescores, true, true, false},
        {"suda", "preparebudget", &preparebudget, true, true, false},
        {"suda", "submitbudget", &submitbudget, true, true, false},
        {"suda", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"suda", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"suda", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"suda", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"suda", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"suda", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"suda", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"suda", "checkbudgets", &checkbudgets, true, true, false},
        {"suda", "mnsync", &mnsync, true, true, false},
        {"suda", "spork", &spork, true, true, false},
...
{
    return "> suda-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:44442/\n";
}
