...
/* suda GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Suda Coin"
#define QAPP_ORG_DOMAIN "suda-tv.com"
#define QAPP_APP_NAME_DEFAULT "Suda Coin-Qt"
#define QAPP_APP_NAME_TESTNET "Suda Coin-Qt-testnet"
