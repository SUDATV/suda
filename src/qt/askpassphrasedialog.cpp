...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            sudaGUI* window = static_cast<sudaGUI*>(parentWidget());
...
{
    sudaGUI* gui = static_cast<sudaGUI*>(parentWidget());
...
{
    hide();
    static_cast<sudaGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("Suda Coin will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your SUDAs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
