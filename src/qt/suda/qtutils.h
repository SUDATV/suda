...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, sudaGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, sudaGUI* gui, double posX = 3);
