...
#include "qt/suda/sendcustomfeedialog.h"
#include "qt/suda/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(sudaGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &sudaGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
