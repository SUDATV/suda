...
#include "qt/suda/forms/ui_masternodeswidget.h"

#include "qt/suda/qtutils.h"
#include "qt/suda/mnrow.h"
#include "qt/suda/mninfodialog.h"
#include "qt/suda/masternodewizarddialog.h"
...
MasterNodesWidget::MasterNodesWidget(sudaGUI *parent) :
    PWidget(parent),
...
void MasterNodesWidget::onCreateMNClicked()
{
    ...
    if (walletModel->getBalance() <= GetMNCollateral(chainActive.Height()) * COIN) {
        inform(tr("Not enough balance to create a masternode, %1 SUDA required.").arg(GetMNCollateral(chainActive.Height())));
        return;
    }
    showHideOp(true);
