...
#ifndef suda_CORE_NEW_GUI_sudaGUI_H
#define suda_CORE_NEW_GUI_sudaGUI_H
...
#include "qt/suda/navmenuwidget.h"
#include "qt/suda/topbar.h"
#include "qt/suda/dashboardwidget.h"
#include "qt/suda/send.h"
#include "qt/suda/receivewidget.h"
#include "qt/suda/addresseswidget.h"
#include "qt/suda/coldstakingwidget.h"
#include "qt/suda/masternodeswidget.h"
#include "qt/suda/snackbar.h"
#include "qt/suda/settings/settingswidget.h"
...
/**
  suda GUI main class. This class represents the main window of the suda UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class sudaGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit sudaGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~sudaGUI();
...
#endif //suda_CORE_NEW_GUI_sudaGUI_H
