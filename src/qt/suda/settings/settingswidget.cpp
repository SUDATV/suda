...
#include "qt/suda/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(sudaGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &sudaGUI::openFAQ);
