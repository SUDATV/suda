...
#include "qt/suda/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/suda/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(sudaGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
           ...
           ui->labelNumber_UnspendableSUDA,
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableSUDA,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableSUDA,
    ...
    connect(ui->pushButton_UnspendableSUDA, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableSUDA);});
    ...
    if (parent)
        connect(parent, &sudaGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
