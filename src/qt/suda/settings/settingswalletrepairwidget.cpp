...
#include "qt/suda/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/suda/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(sudaGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to sudaGUI::handleRestart()
