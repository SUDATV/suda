...
#include "qt/suda/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/suda/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(sudaGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
	...
	message(CMD_REPLY, (tr("Welcome to the Suda Coin RPC console.") + "<br>" +
