...
#include "qt/suda/settings/settingsnetworkwidget.h"
#include "qt/suda/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/suda/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(sudaGUI* _window, QWidget *parent) :
