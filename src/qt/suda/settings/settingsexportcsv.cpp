...
#include "qt/suda/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(sudaGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("suda_tx_csv_export(*.csv)") : tr("suda_addresses_csv_export(*.csv)"),
                                        nullptr);
