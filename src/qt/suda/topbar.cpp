...
#include "qt/suda/topbar.h"
#include "qt/suda/forms/ui_topbar.h"
#include "qt/suda/lockunlock.h"
#include "qt/suda/qtutils.h"
#include "qt/suda/receivedialog.h"
#include "qt/suda/loadingdialog.h"
...
TopBar::TopBar(sudaGUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopSUDA}, "amount-small-topbar");
    setCssProperty({ui->labelAmountSUDA}, "amount-topbar");
    setCssProperty({ui->labelPendingSUDA, ui->labelImmatureSUDA}, "amount-small-topbar");
...
void TopBar::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("suda")
    updateDisplayUnit();
                            ...
                            const CAmount& delegatedBalance, const CAmount& coldStakedBalance)
{
    ...
    // SUDA Total
    QString totalSUDA = GUIUtil::formatBalance(balance, nDisplayUnit);

    // SUDA
    // Top
    ui->labelAmountTopSUDA->setText(totalSUDA);
    // Expanded
    ui->labelAmountSUDA->setText(totalSUDA);
    ui->labelPendingSUDA->setText(GUIUtil::formatBalance(unconfirmedBalance, nDisplayUnit));
    ui->labelImmatureSUDA->setText(GUIUtil::formatBalance(immatureBalance, nDisplayUnit));
}
