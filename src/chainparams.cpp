...
public:
    CMainParams()
    {
        ...
        genesis = CreateGenesisBlock(1643187777, 1697156, "The end of the world order as we know it");
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256("00000e90d23a56cf5d6851c407c3e2ddd2c543a34f6bc8efa9542840d85720b2"));
        assert(genesis.hashMerkleRoot == uint256("8974f175c6c49d253a57056d0b1a1347cc8d132e5ff9cd6eab83da6297e329c8"));
 
        consensus.fPowAllowMinDifficultyBlocks = false;
        consensus.powLimit   = ~UINT256_ZERO >> 20;   // suda starting difficulty is 1 / 2^12
        ...
        consensus.devAddress = "SUDAdisabledXXXXXXXXXXXXXXXXXXXXXX";
        ...
        vSeeds.push_back(CDNSSeedData("206.166.251.61", "206.166.251.61"));
        vSeeds.push_back(CDNSSeedData("45.61.137.156", "45.61.137.156"));
        vSeeds.push_back(CDNSSeedData("168.100.8.168", "168.100.8.168"));
        vSeeds.push_back(CDNSSeedData("45.61.137.206", "45.61.137.206"));
        vSeeds.push_back(CDNSSeedData("206.188.196.118", "206.188.196.118"));

        // Note that of those with the service bits flag, most only support a subset of possible options

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 63);		// SUDA addresses start with 'S'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 8);		// SUDA script addresses start with '4'
        base58Prefixes[STAKING_ADDRESS] = std::vector<unsigned char>(1, 68);	// SUDA private keys start with 'U'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 212);
        // SUDA BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // SUDA BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
...
*/
	...
	//assert(consensus.hashGenesisBlock == uint256S("0x001"));
        ...
        consensus.powLimit   = ~UINT256_ZERO >> 14;   // suda starting difficulty is 1 / 2^12
        consensus.posLimitV1 = ~UINT256_ZERO >> 24;
        consensus.posLimitV2 = ~UINT256_ZERO >> 20;
        consensus.nBudgetCycleBlocks = 43200;       // approx. 1 every 30 days
        consensus.nBudgetFeeConfirmations = 6;      // Number of confirmations for the finalization fee
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 75); // SUDA addresses start with 'X'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 4); // SUDA script addresses start with '3'
        base58Prefixes[STAKING_ADDRESS] = std::vector<unsigned char>(1, 80); // SUDA private keys start with 'Z'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 212);
        // SUDA BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
	base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
	// SUDA BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
