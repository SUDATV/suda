...
The suda project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/SUDATV/suda/blob/master/doc/translation_process.md)
...
The following applies to code changes to the suda project, and is not to be
confused with overall suda Network Protocol consensus changes.

Whether a pull request is merged into suda rests with the project merge
...
Patches that change suda consensus rules are considerably more involved than
...
Where a patchset proposes to change the suda consensus, it must have been
...
The project leader is the release manager for each suda release.
