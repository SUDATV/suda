...
The script [extract-osx-sdk.sh](https://github.com/SUDATV/suda/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
suda/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/SUDATV/suda/blob/master/doc/README_osx.md) for troubleshooting tips.
